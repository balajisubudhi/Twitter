...
shinyUI(pageWithSidebar(
  ...
  sidebarPanel(
    ...
    textInput("entity1", "Entity 1:First Entity's Name or First Term Here", "Obama"),
    textInput ("entity2","Entity 2:Please Enter Second Entity's Name or Second Term Here", "Modi"),
    sliderInput("maxTweets","Number of recent tweets to use for analysis:",min=5,max=500,value=50), # The max can, of course, be increased
